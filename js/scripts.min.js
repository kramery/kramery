$(function() {
    ...
    $(document).ready(function(o) {
        $(".menu li a, .hire-background a").on("click", function(o) {
            a >= 768 && e.animate({
                scrollTop: $(this.hash).offset().top - 50
            }, 800, "easeInOutQuart"), 767 >= a && e.animate({
                scrollTop: $(this.hash).offset().top - 0
            }, 800, "easeInOutQuart"), o.preventDefault()
        })
    }), $(".dial").knob({
        width: "100",
        height: "100",
    ...
    i.on("click", function(e) {
        l.hasClass("show-menu") ? l.removeClass("show-menu") : l.addClass("show-menu"), e.stopPropagation()
    }), i.on("click", function() {
        i.hasClass("toggle-close") ? i.removeClass("toggle-close") : i.addClass("toggle-close")
    }), 767 >= a && $(document).on("click", function() {
        l.hasClass("show-menu") && l.removeClass("show-menu"), i.hasClass("toggle-close") && i.removeClass("toggle-close")
    })
});